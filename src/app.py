...
activities = {
    ...
    "Track and Field": {
        "description": "Training for track events and field competitions",
        "schedule": "Tuesdays, Wednesdays, Fridays, 3:45 PM - 5:00 PM",
        "max_participants": 25,
    ...
    "Drama Club": {
        "description": "Performance and acting workshops with theatrical productions",
    ...
    "Science Club": {
        "description": "Hands-on experiments and exploration of physics, chemistry, and biology",
